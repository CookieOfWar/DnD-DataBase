...
<p><em><span tooltip-for="option.TCE" class="tooltipstered tooltip">Опциональный</span> вариант боевого стиля</em></p>
<p>Вы изучаете один <span>боевой приём</span>&nbsp;<span></span> на ваш выбор из списка архетипа воина «Мастер боевых искусств». Если приём требует, чтобы цель совершила спасбросок для сопротивления эффекту приёма, то Сл спасброска равна 8 + ваш бонус мастерства + ваш модификатор Силы или Ловкости (по вашему выбору).</p>
...
<p><em>3-й уровень, умение воина</em></p>
	<p>Вы выбираете архетип, отражающий стиль и технику, к которым вы стремитесь. Подробности всех архетипов приведены <span>ниже</span>. Выбранный вами архетип предоставляет вам умения на 3-м, 7-м, 10-м, 15-м и 18-м уровнях.</p>
<br>`,
...
<h3 class="underlined"><span id="feature.martial-versatility">Универсальность воина</span></h3>
	...
	<li>Если вам известен какой-либо <span>приём</span>, вы можете заменить этот приём на другой. </li>
	</ul>
	</div>
<br>`,
