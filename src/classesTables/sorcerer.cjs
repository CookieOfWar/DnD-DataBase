const details = {
  table: `
<table class="class_table class_table_4 wide_table"><tbody>
...
<td><span class="tableAbility">Увеличение характеристик</span><span class="tableAbility">, Универсальность чародея</span></td>
...
`,
  explanations: {
	...
	<p>Выберите источник, из которого ваш персонаж черпает свою силу. Все источники раскрыты <span>ниже</span>.</p>
	...
	<p><em>1-й уровень, умение чародея</em></p>
	<p>Определённое событие в вашем прошлом или в жизни ваших родителей или предков оставило на вас неизгладимый отпечаток, связав вас с магией. Ваши заклинания питает некий источник магии, какого бы происхождения он не был. Вы найдёте список заклинаний, доступных чародею в этом разделе: <span>заклинания чародея</span>. Так же правила по использованию заклинаний есть в этой статье: <span><em> использование заклинаний</em</span>.</p>
	<h4 class="smallSectionTitle">Заговоры (заклинания 0-го уровня)</h4>
	<p>На 1-м уровне вам известны четыре <span><strong>заговора</strong></span>, которые вы выбираете из списка заклинаний чародея. Вы обучаетесь дополнительным заговорам чародея на свой выбор по мере роста в уровнях, как это показано в колонке «Известные заговоры».</p>
	...
	<p>Например, если вы знаете заклинание 1-го уровня <span class="spellTip">Огненные ладони</span>, и у вас есть ячейки 1-го и 2-го уровней, вы можете наложить его с помощью любой из этих ячеек.</p>
	...
	<tr><td>1</td><td><span class="spellTip">Едкое варево Таши</span>, <span class="spellTip">Скольжение</span></td></tr>
	<tr><td>2</td><td><span class="spellTip">Горящий клинок</span>, <span class="spellTip">Магическое оружие</span>, <span class="spellTip">Психическая плеть Таши</span>, <span class="spellTip">Пылающий шар</span></td></tr>
	<tr><td>3</td><td><span class="spellTip">Крепость интеллекта</span>, <span class="spellTip">Прикосновение вампира</span></td></tr>
	<tr><td>4</td><td><span class="spellTip">Огненный щит</span></td></tr>
	<tr><td>5</td><td><span class="spellTip">Длань Бигби</span></td></tr>
	<tr><td>6</td><td><span class="spellTip">Окаменение</span>, <span class="spellTip">Отилюков ледяной шар</span>, <span class="spellTip">Потусторонний облик Таши</span></td></tr>
	<tr><td>7</td><td><span class="spellTip">Сон синей вуали</span></td></tr>
	<tr><td>8</td><td><span class="spellTip">Демиплан</span></td></tr>
	<tr><td>9</td><td><span class="spellTip">Клинок разрушения</span></td></tr>
	</tbody></table></div>
	</div>
	...
	<p>Если вы используете заклинание, нацеливаемое только на одно существо и не имеющее дистанцию «на себя», вы можете потратить количество единиц чародейства, равное уровню заклинания (1 для заговоров), чтобы нацелиться им на второе существо-цель в пределах дистанции этого заклинания.</p><p>Чтобы применить этот вариант, заклинание не должно быть способно нацеливаться более чем на одну цель на текущем накладываемом уровне. Например, <span class="spellTip">Волшебная стрела</span> и <span class="spellTip">Палящий луч</span> не могут быть усилены этой метамагией, а <span class="spellTip">Луч холода</span> и <span class="spellTip">Цветной шарик</span>&nbsp;— могут.<br></p>
