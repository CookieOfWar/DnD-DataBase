...
<tr><td>3</td><td>+2</td>
<td><span class="tableAbility">Предмет договора</span>, <span class="tableAbility">Вариант договора</span></td>
...
`,
  explanations: {
	...
	<p>Вы заключаете сделку с потусторонним существом на ваш выбор. Подробности всех покровителей смотрите <span>ниже</span>. Ваш выбор определит умения, предоставляемые вам на 1-м, 6-м, 10-м и 14-м уровнях.</p>
	<br>
	`,
    "магия договора": `
	<h3 class="underlined"><span id="feature.pact-magic">МАГИЯ ДОГОВОРА</span></h3>
	<p><em>1-й уровень, умение колдуна</em></p>
	<p>Исследования тайн и магия, дарованная покровителем, дают вам возможность использовать заклинания. Вы найдёте список заклинаний, доступных колдуну в этом разделе: <strong><span>заклинания колдуна</span>.</strong> Так же правила по использованию заклинаний есть в этой статье: <span><em> использование заклинаний</em</span>.</p>
	<h4 class="smallSectionTitle">Заговоры (заклинания 0-го уровня)</h4>
	<p>Вы знаете два <strong><span>заговора</span></strong> на свой выбор из списка заклинаний колдуна. Вы узнаёте дополнительные заговоры колдуна на более высоких уровнях, как показано в колонке «Известные заговоры».</p>
	...
	<p>Например, если ваш персонаж 5-го уровня, у вас есть две ячейки заклинаний 3-го уровня. Чтобы использовать заклинание 1-го уровня <span class="spellTip">Ведьмин снаряд</span> вы должны потратить одну из этих ячеек, и заклинание сработает как заклинание 3-го уровня.</p>
	...
	<tr><td>Заговор</td><td><span class="spellTip">Вспышка мечей</span>, <span class="spellTip">Громовой клинок</span>, <span class="spellTip">Клинок зеленого пламени</span>, <span class="spellTip">Лассо молнии</span>, <span class="spellTip">Расщепление разума</span></td></tr>
	<tr><td>3</td><td><span class="spellTip">Покров духа</span>, <span class="spellTip">Крепость интеллекта</span>, <span class="spellTip">Призыв духа нежити</span>, <span class="spellTip">Призыв духа тени</span>, <span class="spellTip">Призыв духа феи</span></td></tr>
	<tr><td>4</td><td><span class="spellTip">Призыв духа аберрации</span></td></tr>
	<tr><td>5</td><td><span class="spellTip">Круг телепортации</span>, <span class="spellTip">Планарные узы</span>, <span class="spellTip">Фальшивый двойник</span></td></tr>
	<tr><td>6</td><td><span class="spellTip">Призыв духа исчадия</span>, <span class="spellTip">Потусторонний облик Таши</span></td></tr>
	<tr><td>7</td><td><span class="spellTip">Сон синей вуали</span></td></tr>
	<tr><td>9</td><td><span class="spellTip">Врата</span>, <span class="spellTip">Клинок разрушения</span>, <span class="spellTip">Смертный ужас</span></td></tr>
	</tbody></table></div>
	</div>
	...
	<p>Вы получаете два воззвания на свой выбор. Смотрите <span>список воззваний</span>. Получая новые уровни колдуна, вы получаете дополнительные воззвания на свой выбор, как показано в колонке «<span>известные воззвания</span>».</p>
	...
	<p>Вы узнаёте заклинание <span class="spellTip">Поиск фамильяра</span> и можете сотворять его как ритуал. Это заклинание не учитывается при подсчёте числа заклинаний, которые вы можете знать.</p>
	<p>Когда вы накладываете это заклинание, вы можете выбрать одну из обычных форм для вашего фамильяра, либо одну из особых форм: <span class="creature">бес [imp]</span>, <span class="creature">квазит [quasit]</span>, <span class="creature">псевдодракон [pseudodragon]</span> или <span class="creature">спрайт [sprite]</span>.</p>
