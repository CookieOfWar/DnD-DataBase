const spells = {
  0: [
    ...
    },
    {
      ...
      damage: { 1: "1d8 ", 5: "2d8", 11: "1d8", 17: "2d8" },
      damageType: "Гром",
      classes: ["Волшебник", "Изобретатель", "Колдун", "Чародей"],
      school: "Воплощение",
      range: "На себя (5-футовый радиус)",
    ...
    },
    {
      ...
      classes: [
        "Архетипы: Магия Гравитургии (Волшебник)",
    ...
    },
    {
      ...
      damage: { 1: "1d8 ", 5: "2d12", 11: "3d8", 17: "3d12" },
      damageType: "Некротический",
    ...
    },
    {
      ...
      range: "Касание",
      duration: "Мгновенная",
      time: "Время накладывания: 1 минута",
      concentration: false,
    },
    {
      name: "Раскат грома",
    ...
    },
    {
      ...
      damage: { 1: "1d12", 5: "2d12", 11: "3d12", 17: "4d12" },
      damageType: "Яд",
      classes: ["Волшебник", "Друид", "Изобретатель", "Колдун", "Чародей"],
      school: "Вызов",
      range: "10 футов",
  ...
  1: [
    ...
    },
    {
      ...
      description:
        "Вспышка света устремляется к выбранному вами существу в пределах дистанции. Совершите по цели дальнобойную атаку заклинанием. При попадании цель получает 4к6 урона излучением,\xa0и следующий бросок атаки по цели, совершённый до конца вашего следующего хода, совершается с преимуществом благодаря мистическому тусклому свету, недолго остающемуся на цели.\nНа больших уровнях. Если вы накладываете это заклинание, используя ячейку 2-го уровня или выше, урон увеличивается на 1к6 за каждый уровень ячейки выше 1-го.\n",
      damage: { 1: "4d6 " },
      damageType: "Лучистый",
      classes: ["Жрец"],
      school: "Воплощение",
    ...
    },
    {
      ...
      description:
        "Это заклинание позволяет перемещаться с невероятной скоростью. Когда вы накладываете это заклинание, а также бонусным действием в последующие ходы, пока активно заклинание, вы можете\xa0 совершать действие Рывок.\n",
      damage: { 1: "" },
      damageType: "",
      classes: ["Волшебник", "Изобретатель", "Колдун", "Чародей"],
      school: "Преобразование",
  ...
  2: [
    ...
    },
    {
      ...
      description:
        "Вы черпаете знания у духов прошлого.\xa0Выберите один навык, которым вы не владеете. На время действия заклинания вы получаете владение выбранным навыком. Заклинание оканчивается раньше, если вы накладываете его снова.\n",
      damage: { 1: "" },
      damageType: "",
    ...
    },
    {
      ...
      description:
        "Вы касаетесь существа и можете окончить одну болезнь или одно состояние, в котором оно находится. Этим состоянием может быть\xa0глухота,\xa0отравление,\xa0паралич\xa0или\xa0слепота.\n",
      damage: { 1: "" },
      damageType: "",
      classes: ["Бард", "Друид", "Жрец", "Изобретатель", "Паладин", "Следопыт"],
      school: "Ограждение",
    ...
    },
    {
      ...
      range: "30 футов",
      duration: "Мгновенная",
      time: "Время накладывания: 10 минут",
      concentration: false,
    },
    {
    ...
    },
    {
      ...
      description:
        "Вы магическим образом усиливаете свои движения танцевальными шагами, даруя себе следующие преимущества:\n\nВаша скорость ходьбы увеличивается на 10 футов.\nВы не провоцируете атаки.\nВы можете перемещаться сквозь других существ, и они не считаются для вас\xa0труднопроходимой местностью. Если вы оканчиваете свой ход в пространстве другого существа, то вас выталкивает в последнее занимаемое вами свободное пространство и вы получаете 1к8 урона силовым полем.\n\n",
      damage: { 1: "" },
      damageType: "",
      classes: ["Бард", "Волшебник", "Изобретатель", "Чародей"],
      school: "Преобразование",
  ...
  3: [
    ...
    },
    {
      ...
      description:
        "Вы призываете волну, которая обрушивается на выбранную вами область в пределах дистанции. Эта область может быть до 30 футов длиной, до 10 футов шириной и до 10 футов высотой. Все существа в этой области должны совершить спасбросок Ловкости. При провале существо получает 4к8 дробящего урона и\xa0сбивается с ног. При успехе оно получает половину урона и не\xa0сбивается с ног. После этого вода разливается во все стороны по земле, гася любые незащищённые источники огня в области действия заклинания и в пределах 30 футов от неё, после чего исчезает.\n",
      damage: { 1: "4d8 " },
      damageType: "Дробящий",
      classes: ["Волшебник", "Друид", "Чародей"],
      school: "Вызов",
  ...
  5: [
    ...
    },
    {
      ...
      damage: { 1: "" },
      damageType: "",
      classes: ["Волшебник", "Друид", "Изобретатель"],
      school: "Преобразование",
      range: "120 футов",
      duration: "Пока не рассеяно",
      time: "Действие",
    ...
    },
    {
      ...
      range: "Касание",
      duration: "Мгновенная",
      time: "Время накладывания: 8 часов",
      concentration: false,
    },
    {
    ...
    },
    {
      ...
      range: "Касание",
      duration: "Пока не рассеяно",
      time: "Время накладывания: 24 часа",
      concentration: false,
    },
    {
    ...
    },
    {
      ...
      description:
        "Удерживая жезл, используемый для накладывания заклинания, вы касаетесь незанятого сиденья не более Большого размера. Жезл исчезает, а сиденье превращается в\xa0магический руль [spelljamming helm].",
      damage: { 1: "" },
      damageType: "",
      classes: ["Волшебник", "Изобретатель"],
      school: "Преобразование",
  ...
  6: [
    ...
    },
    {
      ...
      damage: { 1: "6d8 " },
      damageType: "Лучистый",
      classes: ["Волшебник", "Друид", "Жрец", "Чародей"],
      school: "Воплощение",
      range: "На себя (60-футовая линия)",
      duration: "Концентрация, вплоть до 1 минуты",
      time: "Действие",
  ...
  7: [
    ...
    },
    {
      ...
      range: "Касание",
      duration: "Пока не рассеяно",
      time: "Время накладывания: 12 часов",
      concentration: false,
    },
    {
    ...
    },
    {
      ...
      damage: { 1: "" },
      damageType: "",
      classes: ["Волшебник", "Друид", "Жрец", "Колдун", "Чародей"],
      school: "Вызов",
      range: "Касание",
      duration: "Мгновенная",
      time: "Действие",
  ...
  8: [
    ...
    },
    {
      ...
      description:
        "Вы вытягиваете влагу из всех существ в кубе с длиной ребра 30 футов с центром на указанной вами точке в пределах дистанции. Каждое существо в этой области должно совершить спасбросок Телосложения. Это заклинание не действует на Конструктов и Нежить, а Растения и водяные элементали [water elemental]\xa0совершают спасбросок с помехой. При провале существо получает 12к8 урона некротической энергией или половину этого урона при успехе.Немагические растения в области действия заклинания, не являющиеся существами, такие как деревья и кусты, увядают и умирают мгновенно. \n",
      damage: { 1: "12d8 " },
      damageType: "Некротический",
      classes: ["Волшебник", "Чародей"],
      school: "Некромантия",
