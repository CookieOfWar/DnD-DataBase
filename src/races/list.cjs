const Races = {
  gith: {
    0: {
      ...
      features:
        "Увеличение характеристик: Значение вашего Интеллекта увеличивается на 1, а значение вашей Мудрости увеличивается на 2.\n" +
        "Возраст: Гиты достигают совершеннолетия в позднем подростковом возрасте и живут около века.\n" +
        "Размер: Гиты выше и стройнее людей, их рост может достигать 6 футов (1,8 метра).\n" +
        ...
        "Псионика гитцераев. Начиная с 3-го уровня, вы можете накладывать заклинание щит [shield] с помощью этой особенности. Начиная с 5-го уровня, вы также можете накладывать заклинание обнаружение мыслей [detect thoughts] с помощью этой особенности. После накладывания одного из этих заклинаний с помощью особенности вы должны закончить продолжительный отдых, прежде чем сможете вновь наложить это заклинание таким образом. \n" +
    ...
    1: {
      ...
      features:
        ...
        "Языки: Вы можете говорить, читать и писать на Общем и Гитском.\n" +
        "Подрасы: Гиты делятся на два вида: гитцераи и гитъянки. Выберите одну из них.\n" +
        "Декадентское мастерство: В вечном городе Ту’нарате у гитъянки полно времени чтобы чему-нибудь научиться. Вы изучаете один язык по вашему выбору и получаете владение одним навыком или инструментом по вашему выбору.\n" +
        "Псионика гитъянки: Начиная с 3-го уровня, вы можете накладывать заклинание прыжок [jump] с помощью этой особенности. Начиная с 5-го уровня, вы также можете накладывать заклинание туманный шаг [misty step] с помощью этой особенности. После накладывания одного из этих заклинаний с помощью особенности вы должны закончить продолжительный отдых, прежде чем сможете вновь наложить это заклинание таким образом. \n" +
        "Кроме того, вы знаете заговор волшебная рука [mage hand]. Волшебная рука, наложенная при помощи этой особенности, невидима.\n" +
        "Базовой характеристикой для этих заклинаний является Мудрость.",
      passives: {
        0: {
          name: "Воинское воспитание",
          description:
            "Вы владеете легкими и средними доспехами, короткими, длинными и двуручными мечами.",
        },
      },
      reactions: {},
      mastery: [
